...
import 'package:quiznow/dialog/get_coin/get_coin_controller.dart';
...
class GetCoinDialog extends StatelessWidget{
  int coinNum;
  Function() call;
  late GetCoinController controller;
  GetCoinDialog({required this.coinNum,required this.call});

  @override
  Widget build(BuildContext context) {
    controller=Get.put(GetCoinController());
    return WillPopScope(
        child: Material(
      ...
      Column(
        ...
        children: [
          Container(
            ...
            child: TextView(text: "Congratulation！", color: color004FC6, size: 20.sp,fontWeight: FontWeight.w700,),
          ),
          ImageView(imagesName: "answer_right2",width: 230.w,height: 162.h,),
          TextView(text: "+$coinNum", color: colorFFFFFF, size: 30.sp,fontWeight: FontWeight.w700,)
        ],
      )
    ],
  );
